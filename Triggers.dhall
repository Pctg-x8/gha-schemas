let TypedTrigger =
      \(t : Type) ->
        { Type = { types : Optional (List t) }, default.types = None (List t) }
...
let PathTrigger =
      { Type =
          { paths : Optional (List Text), paths-ignore : Optional (List Text) }
      , default = { paths = None (List Text), paths-ignore = None (List Text) }
      }

let CheckRunTriggerTypes =
...
let OnPullRequest =
      { Type =
              BranchTargetTriggerCommonParams.Type
          //\\  (TypedTrigger PullRequestTriggerTypes).Type
      , default =
              BranchTargetTriggerCommonParams.default
          /\  (TypedTrigger PullRequestTriggerTypes).default
      }
...
let OnPullRequestReviewComment =
      TypedTrigger PullRequestReviewCommentTriggerTypes
...
let OnWorkflowRun =
      { Type =
              (TypedTrigger WorkflowRunTriggerTypes).Type
          //\\  { workflows : List Text
                , branches : Optional (List Text)
                , branches-ignore : Optional (List Text)
                }
      , default =
              (TypedTrigger WorkflowRunTriggerTypes).default
          /\  { branches = None (List Text)
              , branches-ignore = None (List Text)
              }
      }

let Schedule = { Type = { cron : Text }, default = {=} }
...
let OnDetails =
      { Type =
          ...
          , pull_request_review_comment :
              Optional OnPullRequestReviewComment.Type
...
let On =
      < Single : UnparameterizedTrigger
      | Multiple : List UnparameterizedTrigger
      | Detailed : OnDetails.Type
      >
